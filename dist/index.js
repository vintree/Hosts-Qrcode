...
/***/ function(module, exports, __webpack_require__) {
	...
	var jrQrcode = __webpack_require__(5);
	...
	var Qrcode = function (_Component) {
	    ...
	    _createClass(Qrcode, [{
	        ...
	        key: 'handleKeykSubmit',
	        value: function handleKeykSubmit(e) {
	            if (e.keyCode === 13) {
	                getBase64.call(this);
	            }
	        }
	        ...
	        value: function render() {
	            ...
	            return React.createElement(
	                ...
	                React.createElement(
	                    'div',
	                    { className: 'header' },
	                    React.createElement('input', { className: 'search-input', type: 'text', placeholder: '\u8BF7\u8F93\u5165\u94FE\u63A5\u5730\u5740', ref: 'address', onKeyUp: this.handleKeykSubmit.bind(this) }),
	                    React.createElement(
	                        'div',
	                        { className: 'submit', onClick: this.handleClickSubmit.bind(this) },
	                        submit.text
	                    )
	                ),
	                React.createElement(
